...
/** @type {string} */
const CACHE_VERSION = '1783353529|1368372229';
/** @type {string} */
const CACHE_PREFIX = 'Buried-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'SpiderSniper.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["SpiderSniper.html","SpiderSniper.js","SpiderSniper.offline.html","SpiderSniper.icon.png","SpiderSniper.apple-touch-icon.png","SpiderSniper.audio.worklet.js","SpiderSniper.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["SpiderSniper.wasm","SpiderSniper.pck"];
